...
pub const microtask = @import("sdk/microtask.zig");
...
comptime {
    ...
    @export(&exports.portalMicroTaskStep, .{ .name = "portalMicroTaskStep", .linkage = .strong });
    @export(&exports.portalGesture, .{ .name = "portalGesture", .linkage = .strong });
}
